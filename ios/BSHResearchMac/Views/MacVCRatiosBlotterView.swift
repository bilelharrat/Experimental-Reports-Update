...
struct MacVCRatiosBlotterView: View {
    ...
    // Interactive Inputs
    @State private var arr: Double = 14.5 // $M ARR
    @State private var netNewArr: Double = 8.2 // $M Net New ARR
    @State private var netBurn: Double = 6.4 // $M Annual Net Burn
    @State private var arrGrowthRate: Double = 85.0 // % YoY Growth
    @State private var fcfMargin: Double = -15.0 // % Free Cash Flow Margin
    @State private var ndr: Double = 132.0 // % Net Dollar Retention
    @State private var cacPaybackMonths: Double = 10.5 // Months CAC Payback
    @State private var smSpend: Double = 5.8 // $M Sales & Marketing Spend
        ...
        VStack(alignment: .leading, spacing: 18) {
            ...
            HStack(alignment: .center) {
                VStack(alignment: .leading, spacing: 3) {
                    ...
                    Text("Investment Committee metrics: capital efficiency, unit economics, cohort expansion, and sales leverage.")
                        .font(.caption)
