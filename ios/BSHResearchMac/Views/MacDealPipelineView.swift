...
struct MacDealPipelineView: View {
    ...
    private var currentStage: String {
        pipeline?.stage ?? "Technical Diligence"
    }
        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            HStack(spacing: 14) {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    Text(pipeline?.introPath ?? "Direct Sourced / Proprietary Founder Inbound")
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    Text(pipeline?.lastTouchpoint ?? "Recent partner briefing & deck review")
                        .font(.caption)
                        .foregroundStyle(.secondary)
                        .lineLimit(2)
                }
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    Text(pipeline?.nextStep ?? "Schedule technical DD call")
                        .font(.caption.weight(.medium))
                        .foregroundStyle(Color.accentColor)
                        .lineLimit(2)
                }
