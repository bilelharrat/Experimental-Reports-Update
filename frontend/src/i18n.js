...
const messages = {
  en: {
    ...
    "console.empty_help":
      "Ask follow-up questions about this company. Claude reads the documents you select once, then keeps them in context for the rest of the session.",
  ...
  zh: {
    ...
    "console.empty_help":
      "针对该公司提出后续问题。Claude 会一次性读取你选定的文档，并在整个会话中保持上下文。",
