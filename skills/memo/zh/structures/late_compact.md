---
en_sha256: 4c28a0b98f863e25d16b39e086aacfa1153afae84a2572939e7bd4d2a2e88c79
---
---
stage: late_compact
version: 1
...
4. 核心风险提示：700-900 词。开头一句点明是哪一条风险单独承载着整个
   投资逻辑。随后是一个 `bullets` 块，`"component": "key_risks"`，
   评分在 6/10 及以上的每条已钉定风险各一项，按钉定顺序排列，且不少于
   三项。维度扫描中判为**弱**的每一个维度，都必须被其中某一项覆盖 ——
   这正是读者所依赖的那道检查。
