---
en_sha256: 58d971c9a3a3b3a06b66ee71dc680e9f7466bf995d6cf484641daa86c98941a7
---
---
stage: late
version: 2
...
3. Investment highlights（核心投资亮点）：以共享事实表中已钉定的案例
   ...
   按钉定顺序排列。每项以已钉定的标题原文开头（它会被渲染为粗体 ——
   读者在第一个句号之前就得到判断），随后是已钉定的证据句。带数字的
   证据句要在读者看到数字之前先说明该数字衡量什么、来自哪里 —— 某个
   具名来源，或"本备忘录自行估算"并附其输入项；绝不能只写 "a
