---
en_sha256: 714ee14a2a135e84dccde16059503d2cbc177db30293d63de79aeb6dfd646410
---
---
en_sha256: PLACEHOLDER
---
---
...
为什么是八个而不是十二个：每个 pass 都会把给它的输出上限填满，因此
十二个 pass 会向第三阶段递交三百多条发现，用来写一份约 3,500 字的
报告，而第三、第四阶段正是一次运行中最花钱的一半。读取同一批证据的
pass 已被合并，让一个 agent 基于一次通读形成一个判断，而不是由两个
agent 各分一半。读取不同证据的 pass —— 以及职责就是唱反调的 pass ——
保持独立。
